...
# Configuration for problem_size 500
PROBLEM_SIZE=500
TASK_BATCH_SIZE=16
MAX_LENGTH=100
CAUSAL="--causal"
...
VAL_PATH="data/tsp/val-500-coords.npy"
MODEL_SAVE_PATH="checkpoints/tsp500"
top_k=16

# Running the training script for problem_size 500
